...
export default function Signup({ onNavigateToLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.success) {
      setError(result.error || "Signup failed. Make sure the organization exists and has no existing admin.");
    } else {
    ...
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-[#070b19]">
      ...
      <div className="w-full max-w-md p-8 z-10">
        ...
        <div className="backdrop-blur-xl bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 shadow-2xl">
          ...
          {successMessage && (
            <div className="flex items-center gap-3 p-3 mb-6 border rounded-xl bg-green-950/20 border-green-500/30 text-green-400 text-sm">
          ...
          <div className="mt-5 text-center text-sm">
            <span className="text-slate-500">Already have an admin account? </span>
            <button
              type="button"
